...
public class ResourceEventDispatchers implements IResourceEventDispatchers {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.github.nest.arcteryx.event.IResourceEventDispatchers#getDispatcher(java.lang.Class)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.github.nest.arcteryx.event.IResourceEventDispatchers#registerDispatcher(com.github.nest.arcteryx.event.IResourceEventDispatcher,
	 *      java.lang.Class)
	 */
	@SuppressWarnings("rawtypes")
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.github.nest.arcteryx.event.IResourceEventDispatchers#unregisterDispatcher(java.lang.Class)
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Override
