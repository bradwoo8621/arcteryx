...
import com.github.nest.arcteryx.Component;
...
public class ResourceRegistrationEventTest {
	...
	public void testStopWithShouldNot() {
		...
		RegistrationListener listener = new RegistrationListener() {
			 ...
			 * (non-Javadoc)
			 * 
			 * @see com.github.nest.arcteryx.event.ResourceRegistrationEventTest.RegistrationListener#resourceShouldUnregister(com.github.nest.arcteryx.event.ResourceRegistrationEvent)
			 */
			@Override
	...
	private static class RegistrationListener extends ResourceRegistrationEventAdapter {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.github.nest.arcteryx.event.ResourceRegistrationEventAdapter#resourceWillRegister(com.github.nest.arcteryx.event.ResourceRegistrationEvent)
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.github.nest.arcteryx.event.ResourceRegistrationEventAdapter#resourceDidRegister(com.github.nest.arcteryx.event.ResourceRegistrationEvent)
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.github.nest.arcteryx.event.ResourceRegistrationEventAdapter#resourceShouldUnregister(com.github.nest.arcteryx.event.ResourceRegistrationEvent)
		 */
		@Override
		public void resourceShouldUnregister(ResourceRegistrationEvent evt) {
			assertEquals("container", evt.getContainer().getId());
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.github.nest.arcteryx.event.ResourceRegistrationEventAdapter#resourceWillUnregister(com.github.nest.arcteryx.event.ResourceRegistrationEvent)
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.github.nest.arcteryx.event.ResourceRegistrationEventAdapter#resourceDidUnregister(com.github.nest.arcteryx.event.ResourceRegistrationEvent)
		 */
		@Override
